...
let ne = new class {
    constructor() {
        A() ? (this.isDebugEnabled = (te(window.location.href, "debug") || "").toLowerCase() in { 1: 1, true: 1 } || "vp" === (te(window.l
...
// setTimeout
    ...
    document.head.appendChild(dn), (() => {
        ...
        const pn = document.head.attributes["data - info"].value; if (pn) {
            const e = pn.split("; ").find((e => e.startsWith("f: "))); if (e) {
                un = e.substring(2); const t = function (e, t) {
                    return !!(Bt(t, "prg - ad - marquee") || Bt(t, "prg - ad - marquee - v3") || Bt(t, "prg - ad - mq - tmo - v3 - h"))
                        || !Bt(t, "prg - ad - marquee - v3 - h") && (e && e.loc